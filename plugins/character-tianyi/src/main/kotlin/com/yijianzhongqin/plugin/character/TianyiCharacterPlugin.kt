package com.yijianzhongqin.plugin.character
...
class TianyiCharacterPlugin : Plugin {
    ...
    override val id = PluginId("com.yijianzhongqin.plugin.character.tianyi")
...
class RenderManager(
    ...
    private val eventBus: com.yijianzhongqin.sdk.event.EventBus,
) {
